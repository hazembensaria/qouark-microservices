package com.infotexa.userservice.domain;
...
import static com.infotexa.userservice.utils.UserUtils.randomUUID;
...
public class Notification implements Serializable {
    ...
    public Notification(Event payload) {
        this(payload , Map.of(ID , randomUUID.get() , TIMESTAMP, now().toString()));
    }
