package com.infotexa.userservice.exception;
...
import static com.infotexa.userservice.utils.RequestUtils.handleErrorResponse;
...
public class HandleException extends ResponseEntityExceptionHandler implements ErrorController {
    ...
    public ResponseEntity<Response> badRequestException(BadRequestException exception) {
        log.error(String.format("BadRequestException: %s", exception.getMessage()));
        return new ResponseEntity<>(
    ...
    public ResponseEntity<Response> forbiddenException(ForbiddenException exception) {
        log.error(String.format("ForbiddenException: %s", exception.getMessage()));
        return new ResponseEntity<>(
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(
        ...
        log.error(String.format("NoHandlerFoundException: %s", exception.getMessage()));
