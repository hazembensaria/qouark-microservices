...
import com.infotexa.userservice.handler.CustomAccessDeniedHandler;
import com.infotexa.userservice.handler.CustomAuthenticationEntryPoint;
...
//                    .cors(cors -> cors.configurationSource(corsConfigurationSource()))
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:8000","http://localhost:4200" , "http://localhost:3000", "https://www.qouark.app"));
